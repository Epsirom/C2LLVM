...
LLVMGenerator.prototype.handleCONDITION = function(node) {
    ...
    if(unaryFlag) {
        ...
        var v1, v2;
        var cmpCode = '';
        v1 = this.handleSHIFT_EXPR(node.children[0].children);
        v2 = this.handleSHIFT_EXPR(node.children[1].children);
        condllvm = this.newPmap();
...
LLVMGenerator.prototype.handleFORSTAT = function(node) {
    ...
    this.body.push('br i1 %' + condv + ', label %for.body, label %for.end');
    this.body.push('for.body:');
    this.handleBLOCK(node.children[3]);
    this.body.push('br label %for.inc');
    this.body.push('for.inc:');
    this.handleASSIGN(node.children[2]);
    this.body.push('br label %for.cond');
    this.body.push('for.end:');
};
...
LLVMGenerator.prototype.handleWHILESTAT = function(node) {
    ...
    this.body.push('br i1 %' + condv.llvmname + ', label %while.body, label %while.end');
