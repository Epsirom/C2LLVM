// $ANTLR 3.3 Nov 30, 2010 12:50:56 SimpleCv4.g 2014-06-07 23:31:37
...
org.antlr.lang.augmentObject(SimpleCv4Parser.prototype, {
    ...
    program: function() {
        ...
        try {
            ...
            do {
                ...
                if ( (LA1_0==ID||LA1_0==102||(LA1_0>=109 && LA1_0<=119)) ) {
                    alt1=1;
                }
                ...
                case 1 :
                    ...
                    this.pushFollow(SimpleCv4Parser.FOLLOW_statement_in_program735);
        ...
        try {
            ...
            switch (alt2) {
                case 1 :
                    ...
                    this.pushFollow(SimpleCv4Parser.FOLLOW_declaration_in_statement769);
                ...
                case 2 :
                    ...
                    this.pushFollow(SimpleCv4Parser.FOLLOW_variable_in_statement779);
                ...
                case 3 :
                    ...
                    this.pushFollow(SimpleCv4Parser.FOLLOW_structDefinition_in_statement789);
                ...
                case 4 :
                    ...
                    this.pushFollow(SimpleCv4Parser.FOLLOW_typeDefinition_in_statement799);
                ...
                case 5 :
                    ...
                    this.pushFollow(SimpleCv4Parser.FOLLOW_functionHeader_in_statement809);
                    functionHeader6=this.functionHeader();

                    this.state._fsp--;
                    if (this.state.failed) return retval;
                    if ( this.state.backtracking===0 ) stream_functionHeader.add(functionHeader6.getTree());
                    char_literal7=this.match(this.input,101,SimpleCv4Parser.FOLLOW_101_in_statement811); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_101.add(char_literal7);
                ...
                case 6 :
                    ...
                    this.pushFollow(SimpleCv4Parser.FOLLOW_functionHeader_in_statement834);
                    functionHeader8=this.functionHeader();

                    this.state._fsp--;
                    if (this.state.failed) return retval;
                    if ( this.state.backtracking===0 ) stream_functionHeader.add(functionHeader8.getTree());
                    this.pushFollow(SimpleCv4Parser.FOLLOW_block_in_statement836);
                    block9=this.block();
    ...
    declaration: function() {
        ...
        try {
            ...
            char_literal10=this.match(this.input,102,SimpleCv4Parser.FOLLOW_102_in_declaration870); if (this.state.failed) return retval; 
            if ( this.state.backtracking===0 ) stream_102.add(char_literal10);

            string_literal11=this.match(this.input,103,SimpleCv4Parser.FOLLOW_103_in_declaration872); if (this.state.failed) return retval; 
            if ( this.state.backtracking===0 ) stream_103.add(string_literal11);

            char_literal12=this.match(this.input,104,SimpleCv4Parser.FOLLOW_104_in_declaration874); if (this.state.failed) return retval; 
            if ( this.state.backtracking===0 ) stream_104.add(char_literal12);

            this.pushFollow(SimpleCv4Parser.FOLLOW_libname_in_declaration876);
            libname13=this.libname();

            this.state._fsp--;
            if (this.state.failed) return retval;
            if ( this.state.backtracking===0 ) stream_libname.add(libname13.getTree());
            char_literal14=this.match(this.input,105,SimpleCv4Parser.FOLLOW_105_in_declaration878); if (this.state.failed) return retval; 
            if ( this.state.backtracking===0 ) stream_105.add(char_literal14);
    ...
    libname: function() {
        ...
        try {
            ...
            ID15=this.match(this.input,ID,SimpleCv4Parser.FOLLOW_ID_in_libname911); if (this.state.failed) return retval;
            if ( this.state.backtracking===0 ) {
            ...
            switch (alt3) {
                case 1 :
                    ...
                    char_literal16=this.match(this.input,106,SimpleCv4Parser.FOLLOW_106_in_libname914); if (this.state.failed) return retval;
                    if ( this.state.backtracking===0 ) {
                    char_literal16_tree = this.adaptor.create(char_literal16);
                    this.adaptor.addChild(root_0, char_literal16_tree);
                    }
                    ID17=this.match(this.input,ID,SimpleCv4Parser.FOLLOW_ID_in_libname916); if (this.state.failed) return retval;
                    if ( this.state.backtracking===0 ) {
    ...
    variable: function() {
        ...
        try {
            ...
            this.pushFollow(SimpleCv4Parser.FOLLOW_type_in_variable938);
            type18=this.type();

            this.state._fsp--;
            if (this.state.failed) return retval;
            if ( this.state.backtracking===0 ) stream_type.add(type18.getTree());
            this.pushFollow(SimpleCv4Parser.FOLLOW_declarator_in_variable940);
            ...
            if ( ((LA4_0>=132 && LA4_0<=141)) ) {
                alt4=1;
            }
            switch (alt4) {
                case 1 :
                    // SimpleCv4.g:138:26: assignmentOp conditionalExpr
                    this.pushFollow(SimpleCv4Parser.FOLLOW_assignmentOp_in_variable943);
                    assignmentOp20=this.assignmentOp();

                    this.state._fsp--;
                    if (this.state.failed) return retval;
                    if ( this.state.backtracking===0 ) stream_assignmentOp.add(assignmentOp20.getTree());
                    this.pushFollow(SimpleCv4Parser.FOLLOW_conditionalExpr_in_variable945);
            ...
            do {
                ...
                case 1 :
                    ...
                    char_literal22=this.match(this.input,107,SimpleCv4Parser.FOLLOW_107_in_variable950); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_107.add(char_literal22);
                    ...
                    switch (alt5) {
                        case 1 :
                            // SimpleCv4.g:0:0: '*'
                            char_literal23=this.match(this.input,108,SimpleCv4Parser.FOLLOW_108_in_variable952); if (this.state.failed) return retval; 
                            if ( this.state.backtracking===0 ) stream_108.add(char_literal23);
                    ...
                    this.pushFollow(SimpleCv4Parser.FOLLOW_declarator_in_variable955);
                    ...
                    if ( ((LA6_0>=132 && LA6_0<=141)) ) {
                        alt6=1;
                    }
                    switch (alt6) {
                        case 1 :
                            // SimpleCv4.g:138:79: assignmentOp shiftExpr
                            this.pushFollow(SimpleCv4Parser.FOLLOW_assignmentOp_in_variable958);
                            assignmentOp25=this.assignmentOp();

                            this.state._fsp--;
                            if (this.state.failed) return retval;
                            if ( this.state.backtracking===0 ) stream_assignmentOp.add(assignmentOp25.getTree());
                            this.pushFollow(SimpleCv4Parser.FOLLOW_shiftExpr_in_variable960);
            ...
            char_literal27=this.match(this.input,101,SimpleCv4Parser.FOLLOW_101_in_variable966); if (this.state.failed) return retval; 
            if ( this.state.backtracking===0 ) stream_101.add(char_literal27);
    ...
    type: function() {
        ...
        try {
            ...
            this.pushFollow(SimpleCv4Parser.FOLLOW_typeSpecifier_in_type1014);
            ...
            switch (alt8) {
                case 1 :
                    // SimpleCv4.g:0:0: '*'
                    char_literal29=this.match(this.input,108,SimpleCv4Parser.FOLLOW_108_in_type1016); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_108.add(char_literal29);
            ...
            // 144:6: -> ^( C_TYPE typeSpecifier ( '*' )? )
            {
                ...
                // SimpleCv4.g:144:32: ( '*' )?
                if ( stream_108.hasNext() ) {
                    this.adaptor.addChild(root_1, stream_108.nextNode());
        ...
        try {
            ...
            switch (alt9) {
                case 1 :
                    ...
                    string_literal30=this.match(this.input,109,SimpleCv4Parser.FOLLOW_109_in_typeSpecifier1051); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_109.add(string_literal30);
                ...
                case 2 :
                    ...
                    string_literal31=this.match(this.input,110,SimpleCv4Parser.FOLLOW_110_in_typeSpecifier1062); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_110.add(string_literal31);
                ...
                case 3 :
                    ...
                    string_literal32=this.match(this.input,111,SimpleCv4Parser.FOLLOW_111_in_typeSpecifier1073); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_111.add(string_literal32);
                ...
                case 4 :
                    ...
                    string_literal33=this.match(this.input,112,SimpleCv4Parser.FOLLOW_112_in_typeSpecifier1084); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_112.add(string_literal33);
                ...
                case 5 :
                    ...
                    string_literal34=this.match(this.input,113,SimpleCv4Parser.FOLLOW_113_in_typeSpecifier1095); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_113.add(string_literal34);
                ...
                case 6 :
                    ...
                    string_literal35=this.match(this.input,114,SimpleCv4Parser.FOLLOW_114_in_typeSpecifier1106); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_114.add(string_literal35);
                ...
                case 7 :
                    ...
                    string_literal36=this.match(this.input,115,SimpleCv4Parser.FOLLOW_115_in_typeSpecifier1117); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_115.add(string_literal36);
                ...
                case 8 :
                    ...
                    string_literal37=this.match(this.input,116,SimpleCv4Parser.FOLLOW_116_in_typeSpecifier1128); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_116.add(string_literal37);
                ...
                case 9 :
                    ...
                    string_literal38=this.match(this.input,117,SimpleCv4Parser.FOLLOW_117_in_typeSpecifier1139); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_117.add(string_literal38);
                ...
                case 10 :
                    ...
                    ID39=this.match(this.input,ID,SimpleCv4Parser.FOLLOW_ID_in_typeSpecifier1154); if (this.state.failed) return retval; 
    ...
    declarator: function() {
        ...
        try {
            ...
            ID40=this.match(this.input,ID,SimpleCv4Parser.FOLLOW_ID_in_declarator1182); if (this.state.failed) return retval;
            if ( this.state.backtracking===0 ) {
    ...
    typeDefinition: function() {
        ...
        try {
            ...
            string_literal41=this.match(this.input,118,SimpleCv4Parser.FOLLOW_118_in_typeDefinition1203); if (this.state.failed) return retval; 
            if ( this.state.backtracking===0 ) stream_118.add(string_literal41);

            this.pushFollow(SimpleCv4Parser.FOLLOW_oldTypeName_in_typeDefinition1205);
            oldTypeName42=this.oldTypeName();

            this.state._fsp--;
            if (this.state.failed) return retval;
            if ( this.state.backtracking===0 ) stream_oldTypeName.add(oldTypeName42.getTree());
            this.pushFollow(SimpleCv4Parser.FOLLOW_newTypeName_in_typeDefinition1207);
            newTypeName43=this.newTypeName();

            this.state._fsp--;
            if (this.state.failed) return retval;
            if ( this.state.backtracking===0 ) stream_newTypeName.add(newTypeName43.getTree());
            char_literal44=this.match(this.input,101,SimpleCv4Parser.FOLLOW_101_in_typeDefinition1209); if (this.state.failed) return retval; 
            if ( this.state.backtracking===0 ) stream_101.add(char_literal44);
    ...
    oldTypeName: function() {
        ...
        try {
            ...
            this.pushFollow(SimpleCv4Parser.FOLLOW_typeSpecifier_in_oldTypeName1250);
    ...
    newTypeName: function() {
        ...
        try {
            ...
            ID46=this.match(this.input,ID,SimpleCv4Parser.FOLLOW_ID_in_newTypeName1270); if (this.state.failed) return retval;
            if ( this.state.backtracking===0 ) {
        ...
        try {
            ...
            switch (alt10) {
                case 1 :
                    ...
                    string_literal47=this.match(this.input,118,SimpleCv4Parser.FOLLOW_118_in_structDefinition1297); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_118.add(string_literal47);
            ...
            string_literal48=this.match(this.input,119,SimpleCv4Parser.FOLLOW_119_in_structDefinition1302); if (this.state.failed) return retval; 
            if ( this.state.backtracking===0 ) stream_119.add(string_literal48);

            this.pushFollow(SimpleCv4Parser.FOLLOW_structName_in_structDefinition1304);
            structName49=this.structName();

            this.state._fsp--;
            if (this.state.failed) return retval;
            if ( this.state.backtracking===0 ) stream_structName.add(structName49.getTree());
            this.pushFollow(SimpleCv4Parser.FOLLOW_structBlock_in_structDefinition1306);
            ...
            switch (alt12) {
                case 1 :
                    ...
                    this.pushFollow(SimpleCv4Parser.FOLLOW_structVar_in_structDefinition1310);
                    ...
                    do {
                        ...
                        case 1 :
                            ...
                            char_literal52=this.match(this.input,107,SimpleCv4Parser.FOLLOW_107_in_structDefinition1314); if (this.state.failed) return retval; 
                            if ( this.state.backtracking===0 ) stream_107.add(char_literal52);

                            this.pushFollow(SimpleCv4Parser.FOLLOW_structVar_in_structDefinition1316);
            ...
            char_literal54=this.match(this.input,101,SimpleCv4Parser.FOLLOW_101_in_structDefinition1324); if (this.state.failed) return retval; 
            if ( this.state.backtracking===0 ) stream_101.add(char_literal54);
    ...
    structName: function() {
        ...
        try {
            ...
            ID55=this.match(this.input,ID,SimpleCv4Parser.FOLLOW_ID_in_structName1365); if (this.state.failed) return retval;
            if ( this.state.backtracking===0 ) {
    ...
    structVar: function() {
        ...
        try {
            ...
            this.pushFollow(SimpleCv4Parser.FOLLOW_declarator_in_structVar1384);
    ...
    structBlock: function() {
        ...
        try {
            ...
            char_literal57=this.match(this.input,120,SimpleCv4Parser.FOLLOW_120_in_structBlock1416); if (this.state.failed) return retval; 
            if ( this.state.backtracking===0 ) stream_120.add(char_literal57);
            ...
            do {
                ...
                if ( (LA13_0==ID||(LA13_0>=109 && LA13_0<=117)) ) {
                    alt13=1;
                }
                ...
                case 1 :
                    ...
                    this.pushFollow(SimpleCv4Parser.FOLLOW_variable_in_structBlock1430);
            ...
            char_literal59=this.match(this.input,121,SimpleCv4Parser.FOLLOW_121_in_structBlock1441); if (this.state.failed) return retval; 
            if ( this.state.backtracking===0 ) stream_121.add(char_literal59);
    ...
    functionHeader: function() {
        ...
        try {
            ...
            this.pushFollow(SimpleCv4Parser.FOLLOW_type_in_functionHeader1470);
            type60=this.type();

            this.state._fsp--;
            if (this.state.failed) return retval;
            if ( this.state.backtracking===0 ) stream_type.add(type60.getTree());
            ID61=this.match(this.input,ID,SimpleCv4Parser.FOLLOW_ID_in_functionHeader1472); if (this.state.failed) return retval; 
            if ( this.state.backtracking===0 ) stream_ID.add(ID61);

            char_literal62=this.match(this.input,122,SimpleCv4Parser.FOLLOW_122_in_functionHeader1474); if (this.state.failed) return retval; 
            if ( this.state.backtracking===0 ) stream_122.add(char_literal62);

            // SimpleCv4.g:209:21: ( formalParameter ( ',' formalParameter )* )?
            var alt15=2;
            var LA15_0 = this.input.LA(1);

            if ( (LA15_0==ID||(LA15_0>=109 && LA15_0<=117)) ) {
                alt15=1;
            }
            switch (alt15) {
                case 1 :
                    // SimpleCv4.g:209:23: formalParameter ( ',' formalParameter )*
                    this.pushFollow(SimpleCv4Parser.FOLLOW_formalParameter_in_functionHeader1478);
                    ...
                    do {
                        ...
                        case 1 :
                            ...
                            char_literal64=this.match(this.input,107,SimpleCv4Parser.FOLLOW_107_in_functionHeader1482); if (this.state.failed) return retval; 
                            if ( this.state.backtracking===0 ) stream_107.add(char_literal64);

                            this.pushFollow(SimpleCv4Parser.FOLLOW_formalParameter_in_functionHeader1484);
            ...
            char_literal66=this.match(this.input,123,SimpleCv4Parser.FOLLOW_123_in_functionHeader1492); if (this.state.failed) return retval; 
            if ( this.state.backtracking===0 ) stream_123.add(char_literal66);
    ...
    formalParameter: function() {
        ...
        try {
            ...
            this.pushFollow(SimpleCv4Parser.FOLLOW_type_in_formalParameter1533);
            type67=this.type();

            this.state._fsp--;
            if (this.state.failed) return retval;
            if ( this.state.backtracking===0 ) stream_type.add(type67.getTree());
            this.pushFollow(SimpleCv4Parser.FOLLOW_declarator_in_formalParameter1535);
        ...
        try {
            ...
            switch (alt18) {
                case 1 :
                    ...
                    char_literal69=this.match(this.input,120,SimpleCv4Parser.FOLLOW_120_in_block1577); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_120.add(char_literal69);
                    ...
                    do {
                        ...
                        if ( (LA16_0==ID) ) {
                            ...
                            if ( (LA16_2==108) ) {
                                ...
                                if ( (LA16_4==ID) ) {
                                    ...
                                    else if ( (LA16_5==107||(LA16_5>=132 && LA16_5<=141)) ) {
                                        alt16=1;
                                    }
                        ...
                        case 1 :
                            // SimpleCv4.g:0:0: variable
                            this.pushFollow(SimpleCv4Parser.FOLLOW_variable_in_block1591);
                    ...
                    do {
                        ...
                        if ( ((LA17_0>=ID && LA17_0<=STRING)||LA17_0==108||LA17_0==122||(LA17_0>=124 && LA17_0<=127)||(LA17_0>=129 && LA17_0<=131)||(LA17_0>=142 && LA17_0<=146)) ) {
                            alt17=1;
                        }
                        ...
                        case 1 :
                            ...
                            this.pushFollow(SimpleCv4Parser.FOLLOW_stat_in_block1606);
                            stat71=this.stat();
                    ...
                    char_literal72=this.match(this.input,121,SimpleCv4Parser.FOLLOW_121_in_block1617); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_121.add(char_literal72);
                ...
                case 2 :
                    ...
                    this.pushFollow(SimpleCv4Parser.FOLLOW_stat_in_block1647);
                    stat73=this.stat();
                ...
                case 3 :
                    // SimpleCv4.g:226:9: ';'
                    char_literal74=this.match(this.input,101,SimpleCv4Parser.FOLLOW_101_in_block1670); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_101.add(char_literal74);
        ...
        try {
            ...
            switch (alt19) {
                case 1 :
                    ...
                    this.pushFollow(SimpleCv4Parser.FOLLOW_forStat_in_stat1698);
                ...
                case 2 :
                    ...
                    this.pushFollow(SimpleCv4Parser.FOLLOW_whileStat_in_stat1708);
                ...
                case 3 :
                    ...
                    this.pushFollow(SimpleCv4Parser.FOLLOW_ifStat_in_stat1718);
                ...
                case 4 :
                    ...
                    this.pushFollow(SimpleCv4Parser.FOLLOW_expression_in_stat1728);
                    expression78=this.expression();

                    this.state._fsp--;
                    if (this.state.failed) return retval;
                    if ( this.state.backtracking===0 ) stream_expression.add(expression78.getTree());
                    char_literal79=this.match(this.input,101,SimpleCv4Parser.FOLLOW_101_in_stat1730); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_101.add(char_literal79);
                ...
                case 5 :
                    ...
                    this.pushFollow(SimpleCv4Parser.FOLLOW_jumpStat_in_stat1760);
    ...
    forStat: function() {
        ...
        try {
            ...
            string_literal81=this.match(this.input,124,SimpleCv4Parser.FOLLOW_124_in_forStat1780); if (this.state.failed) return retval; 
            if ( this.state.backtracking===0 ) stream_124.add(string_literal81);

            char_literal82=this.match(this.input,122,SimpleCv4Parser.FOLLOW_122_in_forStat1782); if (this.state.failed) return retval; 
            if ( this.state.backtracking===0 ) stream_122.add(char_literal82);

            this.pushFollow(SimpleCv4Parser.FOLLOW_assignmentExpr_in_forStat1784);
            assignmentExpr83=this.assignmentExpr();

            this.state._fsp--;
            if (this.state.failed) return retval;
            if ( this.state.backtracking===0 ) stream_assignmentExpr.add(assignmentExpr83.getTree());
            char_literal84=this.match(this.input,101,SimpleCv4Parser.FOLLOW_101_in_forStat1786); if (this.state.failed) return retval; 
            if ( this.state.backtracking===0 ) stream_101.add(char_literal84);

            this.pushFollow(SimpleCv4Parser.FOLLOW_conditionalExpr_in_forStat1788);
            conditionalExpr85=this.conditionalExpr();

            this.state._fsp--;
            if (this.state.failed) return retval;
            if ( this.state.backtracking===0 ) stream_conditionalExpr.add(conditionalExpr85.getTree());
            char_literal86=this.match(this.input,101,SimpleCv4Parser.FOLLOW_101_in_forStat1790); if (this.state.failed) return retval; 
            if ( this.state.backtracking===0 ) stream_101.add(char_literal86);

            this.pushFollow(SimpleCv4Parser.FOLLOW_expression_in_forStat1792);
            expression87=this.expression();

            this.state._fsp--;
            if (this.state.failed) return retval;
            if ( this.state.backtracking===0 ) stream_expression.add(expression87.getTree());
            char_literal88=this.match(this.input,123,SimpleCv4Parser.FOLLOW_123_in_forStat1794); if (this.state.failed) return retval; 
            if ( this.state.backtracking===0 ) stream_123.add(char_literal88);

            this.pushFollow(SimpleCv4Parser.FOLLOW_block_in_forStat1796);
            block89=this.block();
            ...
            // AST REWRITE
            // elements: expression, assignmentExpr, block, conditionalExpr
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
        ...
        try {
            ...
            switch (alt20) {
                case 1 :
                    ...
                    string_literal90=this.match(this.input,125,SimpleCv4Parser.FOLLOW_125_in_whileStat1845); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_125.add(string_literal90);

                    char_literal91=this.match(this.input,122,SimpleCv4Parser.FOLLOW_122_in_whileStat1847); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_122.add(char_literal91);

                    this.pushFollow(SimpleCv4Parser.FOLLOW_conditionalExpr_in_whileStat1849);
                    conditionalExpr92=this.conditionalExpr();

                    this.state._fsp--;
                    if (this.state.failed) return retval;
                    if ( this.state.backtracking===0 ) stream_conditionalExpr.add(conditionalExpr92.getTree());
                    char_literal93=this.match(this.input,123,SimpleCv4Parser.FOLLOW_123_in_whileStat1851); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_123.add(char_literal93);

                    this.pushFollow(SimpleCv4Parser.FOLLOW_block_in_whileStat1853);
                    block94=this.block();
                ...
                case 2 :
                    ...
                    string_literal95=this.match(this.input,126,SimpleCv4Parser.FOLLOW_126_in_whileStat1877); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_126.add(string_literal95);

                    this.pushFollow(SimpleCv4Parser.FOLLOW_block_in_whileStat1879);
                    block96=this.block();

                    this.state._fsp--;
                    if (this.state.failed) return retval;
                    if ( this.state.backtracking===0 ) stream_block.add(block96.getTree());
                    string_literal97=this.match(this.input,125,SimpleCv4Parser.FOLLOW_125_in_whileStat1881); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_125.add(string_literal97);

                    char_literal98=this.match(this.input,122,SimpleCv4Parser.FOLLOW_122_in_whileStat1883); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_122.add(char_literal98);

                    this.pushFollow(SimpleCv4Parser.FOLLOW_conditionalExpr_in_whileStat1885);
                    conditionalExpr99=this.conditionalExpr();

                    this.state._fsp--;
                    if (this.state.failed) return retval;
                    if ( this.state.backtracking===0 ) stream_conditionalExpr.add(conditionalExpr99.getTree());
                    char_literal100=this.match(this.input,123,SimpleCv4Parser.FOLLOW_123_in_whileStat1887); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_123.add(char_literal100);

                    char_literal101=this.match(this.input,101,SimpleCv4Parser.FOLLOW_101_in_whileStat1889); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_101.add(char_literal101);
    ...
    ifStat: function() {
        ...
        try {
            ...
            string_literal102=this.match(this.input,127,SimpleCv4Parser.FOLLOW_127_in_ifStat1922); if (this.state.failed) return retval; 
            if ( this.state.backtracking===0 ) stream_127.add(string_literal102);

            char_literal103=this.match(this.input,122,SimpleCv4Parser.FOLLOW_122_in_ifStat1924); if (this.state.failed) return retval; 
            if ( this.state.backtracking===0 ) stream_122.add(char_literal103);

            this.pushFollow(SimpleCv4Parser.FOLLOW_conditionalExpr_in_ifStat1926);
            ...
            char_literal105=this.match(this.input,123,SimpleCv4Parser.FOLLOW_123_in_ifStat1928); if (this.state.failed) return retval; 
            if ( this.state.backtracking===0 ) stream_123.add(char_literal105);

            this.pushFollow(SimpleCv4Parser.FOLLOW_block_in_ifStat1930);
            block106=this.block();
            ...
            do {
                ...
                case 1 :
                    ...
                    string_literal107=this.match(this.input,128,SimpleCv4Parser.FOLLOW_128_in_ifStat1934); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_128.add(string_literal107);

                    string_literal108=this.match(this.input,127,SimpleCv4Parser.FOLLOW_127_in_ifStat1936); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_127.add(string_literal108);

                    char_literal109=this.match(this.input,122,SimpleCv4Parser.FOLLOW_122_in_ifStat1938); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_122.add(char_literal109);

                    this.pushFollow(SimpleCv4Parser.FOLLOW_conditionalExpr_in_ifStat1940);
                    ...
                    char_literal111=this.match(this.input,123,SimpleCv4Parser.FOLLOW_123_in_ifStat1942); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_123.add(char_literal111);

                    this.pushFollow(SimpleCv4Parser.FOLLOW_block_in_ifStat1944);
                    block112=this.block();
            ...
            switch (alt22) {
                case 1 :
                    ...
                    string_literal113=this.match(this.input,128,SimpleCv4Parser.FOLLOW_128_in_ifStat1951); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_128.add(string_literal113);
            ...
            // AST REWRITE
            // elements: conditionalExpr, conditionalExpr, block, block, block
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
        ...
        try {
            ...
            switch (alt24) {
                case 1 :
                    ...
                    string_literal115=this.match(this.input,129,SimpleCv4Parser.FOLLOW_129_in_jumpStat2008); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_129.add(string_literal115);

                    char_literal116=this.match(this.input,101,SimpleCv4Parser.FOLLOW_101_in_jumpStat2010); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_101.add(char_literal116);
                ...
                case 2 :
                    ...
                    string_literal117=this.match(this.input,130,SimpleCv4Parser.FOLLOW_130_in_jumpStat2031); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_130.add(string_literal117);

                    char_literal118=this.match(this.input,101,SimpleCv4Parser.FOLLOW_101_in_jumpStat2033); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_101.add(char_literal118);
                ...
                case 3 :
                    ...
                    string_literal119=this.match(this.input,131,SimpleCv4Parser.FOLLOW_131_in_jumpStat2054); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_131.add(string_literal119);

                    // SimpleCv4.g:261:17: ( expression )?
                    var alt23=2;
                    var LA23_0 = this.input.LA(1);

                    if ( ((LA23_0>=ID && LA23_0<=STRING)||LA23_0==108||LA23_0==122||(LA23_0>=142 && LA23_0<=146)) ) {
                        alt23=1;
                    }
                    switch (alt23) {
                        case 1 :
                            // SimpleCv4.g:261:18: expression
                            this.pushFollow(SimpleCv4Parser.FOLLOW_expression_in_jumpStat2057);
                    ...
                    char_literal121=this.match(this.input,101,SimpleCv4Parser.FOLLOW_101_in_jumpStat2061); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_101.add(char_literal121);
    ...
    funcInvoke: function() {
        ...
        try {
            ...
            ID122=this.match(this.input,ID,SimpleCv4Parser.FOLLOW_ID_in_funcInvoke2099); if (this.state.failed) return retval; 
            if ( this.state.backtracking===0 ) stream_ID.add(ID122);

            char_literal123=this.match(this.input,122,SimpleCv4Parser.FOLLOW_122_in_funcInvoke2101); if (this.state.failed) return retval; 
            if ( this.state.backtracking===0 ) stream_122.add(char_literal123);

            // SimpleCv4.g:266:16: ( shiftExpr ( ',' shiftExpr )* )?
            var alt26=2;
            var LA26_0 = this.input.LA(1);

            if ( ((LA26_0>=ID && LA26_0<=STRING)||LA26_0==108||LA26_0==122||(LA26_0>=142 && LA26_0<=146)) ) {
                alt26=1;
            }
            switch (alt26) {
                case 1 :
                    // SimpleCv4.g:266:18: shiftExpr ( ',' shiftExpr )*
                    this.pushFollow(SimpleCv4Parser.FOLLOW_shiftExpr_in_funcInvoke2105);
                    ...
                    do {
                        ...
                        case 1 :
                            ...
                            char_literal125=this.match(this.input,107,SimpleCv4Parser.FOLLOW_107_in_funcInvoke2109); if (this.state.failed) return retval; 
                            if ( this.state.backtracking===0 ) stream_107.add(char_literal125);

                            this.pushFollow(SimpleCv4Parser.FOLLOW_shiftExpr_in_funcInvoke2111);
            ...
            char_literal127=this.match(this.input,123,SimpleCv4Parser.FOLLOW_123_in_funcInvoke2118); if (this.state.failed) return retval; 
            if ( this.state.backtracking===0 ) stream_123.add(char_literal127);
        ...
        try {
            ...
            switch (alt27) {
                case 1 :
                    ...
                    this.pushFollow(SimpleCv4Parser.FOLLOW_assignmentExpr_in_expression2160);
                ...
                case 2 :
                    ...
                    this.pushFollow(SimpleCv4Parser.FOLLOW_conditionalExpr_in_expression2168);
    ...
    assignmentExpr: function() {
        ...
        try {
            ...
            this.pushFollow(SimpleCv4Parser.FOLLOW_unaryExpr_in_assignmentExpr2187);
            ...
            if ( ((LA28_0>=132 && LA28_0<=141)) ) {
                alt28=1;
            }
            switch (alt28) {
                case 1 :
                    // SimpleCv4.g:276:20: assignmentOp shiftExpr
                    this.pushFollow(SimpleCv4Parser.FOLLOW_assignmentOp_in_assignmentExpr2190);
                    assignmentOp131=this.assignmentOp();

                    this.state._fsp--;
                    if (this.state.failed) return retval;
                    if ( this.state.backtracking===0 ) stream_assignmentOp.add(assignmentOp131.getTree());
                    this.pushFollow(SimpleCv4Parser.FOLLOW_shiftExpr_in_assignmentExpr2192);
    ...
    assignmentOp: function() {
        ...
        try {
            ...
            switch (alt29) {
                case 1 :
                    // SimpleCv4.g:281:9: '='
                    char_literal133=this.match(this.input,132,SimpleCv4Parser.FOLLOW_132_in_assignmentOp2233); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_132.add(char_literal133);
                ...
                case 2 :
                    // SimpleCv4.g:283:9: '+='
                    string_literal134=this.match(this.input,133,SimpleCv4Parser.FOLLOW_133_in_assignmentOp2252); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_133.add(string_literal134);
                ...
                case 3 :
                    // SimpleCv4.g:285:9: '-='
                    string_literal135=this.match(this.input,134,SimpleCv4Parser.FOLLOW_134_in_assignmentOp2271); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_134.add(string_literal135);
                ...
                case 4 :
                    // SimpleCv4.g:287:9: '*='
                    string_literal136=this.match(this.input,135,SimpleCv4Parser.FOLLOW_135_in_assignmentOp2290); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_135.add(string_literal136);
                ...
                case 5 :
                    // SimpleCv4.g:289:9: '/='
                    string_literal137=this.match(this.input,136,SimpleCv4Parser.FOLLOW_136_in_assignmentOp2309); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_136.add(string_literal137);
                ...
                case 6 :
                    // SimpleCv4.g:291:9: '<<='
                    string_literal138=this.match(this.input,137,SimpleCv4Parser.FOLLOW_137_in_assignmentOp2328); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_137.add(string_literal138);
                ...
                case 7 :
                    // SimpleCv4.g:293:9: '>>='
                    string_literal139=this.match(this.input,138,SimpleCv4Parser.FOLLOW_138_in_assignmentOp2347); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_138.add(string_literal139);
                ...
                case 8 :
                    // SimpleCv4.g:295:9: '&='
                    string_literal140=this.match(this.input,139,SimpleCv4Parser.FOLLOW_139_in_assignmentOp2366); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_139.add(string_literal140);
                ...
                case 9 :
                    // SimpleCv4.g:297:9: '|='
                    string_literal141=this.match(this.input,140,SimpleCv4Parser.FOLLOW_140_in_assignmentOp2385); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_140.add(string_literal141);
                ...
                case 10 :
                    // SimpleCv4.g:299:9: '^='
                    string_literal142=this.match(this.input,141,SimpleCv4Parser.FOLLOW_141_in_assignmentOp2404); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_141.add(string_literal142);
    ...
    unaryExpr: function() {
        ...
        try {
            ...
            case ID:
                ...
                else if ( (LA30_1==EOF||LA30_1==101||(LA30_1>=104 && LA30_1<=105)||(LA30_1>=107 && LA30_1<=108)||LA30_1==123||(LA30_1>=132 && LA30_1<=143)||(LA30_1>=147 && LA30_1<=161)) ) {
                    alt30=1;
                }
                else {
                    if (this.state.backtracking>0) {this.state.failed=true; return retval;}
            ...
            switch (alt30) {
                case 1 :
                    ...
                    this.pushFollow(SimpleCv4Parser.FOLLOW_postfixExpr_in_unaryExpr2435);
                ...
                case 2 :
                    ...
                    string_literal144=this.match(this.input,142,SimpleCv4Parser.FOLLOW_142_in_unaryExpr2445); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_142.add(string_literal144);

                    this.pushFollow(SimpleCv4Parser.FOLLOW_unaryExpr_in_unaryExpr2447);
                ...
                case 3 :
                    ...
                    string_literal146=this.match(this.input,143,SimpleCv4Parser.FOLLOW_143_in_unaryExpr2469); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_143.add(string_literal146);

                    this.pushFollow(SimpleCv4Parser.FOLLOW_unaryExpr_in_unaryExpr2471);
                ...
                case 4 :
                    ...
                    string_literal148=this.match(this.input,144,SimpleCv4Parser.FOLLOW_144_in_unaryExpr2493); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_144.add(string_literal148);

                    char_literal149=this.match(this.input,122,SimpleCv4Parser.FOLLOW_122_in_unaryExpr2495); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_122.add(char_literal149);

                    this.pushFollow(SimpleCv4Parser.FOLLOW_type_in_unaryExpr2497);
                    type150=this.type();

                    this.state._fsp--;
                    if (this.state.failed) return retval;
                    if ( this.state.backtracking===0 ) stream_type.add(type150.getTree());
                    char_literal151=this.match(this.input,123,SimpleCv4Parser.FOLLOW_123_in_unaryExpr2499); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_123.add(char_literal151);
                ...
                case 5 :
                    ...
                    this.pushFollow(SimpleCv4Parser.FOLLOW_unaryOp_in_unaryExpr2521);
                    unaryOp152=this.unaryOp();

                    this.state._fsp--;
                    if (this.state.failed) return retval;
                    if ( this.state.backtracking===0 ) this.adaptor.addChild(root_0, unaryOp152.getTree());
                    this.pushFollow(SimpleCv4Parser.FOLLOW_castExpr_in_unaryExpr2523);
                ...
                case 6 :
                    ...
                    this.pushFollow(SimpleCv4Parser.FOLLOW_funcInvoke_in_unaryExpr2531);
    ...
    unaryOp: function() {
        ...
        try {
            ...
            switch (alt31) {
                case 1 :
                    // SimpleCv4.g:316:9: '!'
                    char_literal155=this.match(this.input,145,SimpleCv4Parser.FOLLOW_145_in_unaryOp2554); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_145.add(char_literal155);
                ...
                case 2 :
                    // SimpleCv4.g:318:9: '&'
                    char_literal156=this.match(this.input,146,SimpleCv4Parser.FOLLOW_146_in_unaryOp2572); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_146.add(char_literal156);
                ...
                case 3 :
                    // SimpleCv4.g:320:9: '*'
                    char_literal157=this.match(this.input,108,SimpleCv4Parser.FOLLOW_108_in_unaryOp2590); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_108.add(char_literal157);
    ...
    postfixExpr: function() {
        ...
        try {
            ...
            this.pushFollow(SimpleCv4Parser.FOLLOW_primaryExpr_in_postfixExpr2617);
            ...
            do {
                ...
                if ( ((LA32_0>=142 && LA32_0<=143)||(LA32_0>=147 && LA32_0<=148)) ) {
                    alt32=1;
                }
                ...
                case 1 :
                    ...
                    this.pushFollow(SimpleCv4Parser.FOLLOW_postfix_in_postfixExpr2620);
        ...
        try {
            ...
            switch (alt34) {
                case 1 :
                    ...
                    string_literal160=this.match(this.input,147,SimpleCv4Parser.FOLLOW_147_in_postfix2662); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_147.add(string_literal160);

                    ID161=this.match(this.input,ID,SimpleCv4Parser.FOLLOW_ID_in_postfix2664); if (this.state.failed) return retval; 
                    ...
                    switch (alt33) {
                        case 1 :
                            ...
                            char_literal162=this.match(this.input,148,SimpleCv4Parser.FOLLOW_148_in_postfix2667); if (this.state.failed) return retval; 
                            if ( this.state.backtracking===0 ) stream_148.add(char_literal162);

                            this.pushFollow(SimpleCv4Parser.FOLLOW_shiftExpr_in_postfix2669);
                            shiftExpr163=this.shiftExpr();

                            this.state._fsp--;
                            if (this.state.failed) return retval;
                            if ( this.state.backtracking===0 ) stream_shiftExpr.add(shiftExpr163.getTree());
                            char_literal164=this.match(this.input,149,SimpleCv4Parser.FOLLOW_149_in_postfix2671); if (this.state.failed) return retval; 
                            if ( this.state.backtracking===0 ) stream_149.add(char_literal164);
                ...
                case 2 :
                    // SimpleCv4.g:332:8: '++'
                    string_literal165=this.match(this.input,142,SimpleCv4Parser.FOLLOW_142_in_postfix2702); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_142.add(string_literal165);
                ...
                case 3 :
                    // SimpleCv4.g:334:8: '--'
                    string_literal166=this.match(this.input,143,SimpleCv4Parser.FOLLOW_143_in_postfix2722); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_143.add(string_literal166);
                ...
                case 4 :
                    ...
                    char_literal167=this.match(this.input,148,SimpleCv4Parser.FOLLOW_148_in_postfix2742); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_148.add(char_literal167);

                    this.pushFollow(SimpleCv4Parser.FOLLOW_expression_in_postfix2744);
                    expression168=this.expression();

                    this.state._fsp--;
                    if (this.state.failed) return retval;
                    if ( this.state.backtracking===0 ) stream_expression.add(expression168.getTree());
                    char_literal169=this.match(this.input,149,SimpleCv4Parser.FOLLOW_149_in_postfix2746); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_149.add(char_literal169);
    ...
    // SimpleCv4.g:340:1: primaryExpr : ( declarator | INT | STRING | '(' expression ')' );
    ...
    primaryExpr: function() {
        ...
        try {
            // SimpleCv4.g:341:5: ( declarator | INT | STRING | '(' expression ')' )
            var alt35=4;
            switch ( this.input.LA(1) ) {
            case ID:
                alt35=1;
            ...
            switch (alt35) {
                case 1 :
                    ...
                    this.pushFollow(SimpleCv4Parser.FOLLOW_declarator_in_primaryExpr2777);
                    declarator170=this.declarator();

                    this.state._fsp--;
                    if (this.state.failed) return retval;
                    if ( this.state.backtracking===0 ) this.adaptor.addChild(root_0, declarator170.getTree());


                    break;
                case 2 :
                    // SimpleCv4.g:342:7: INT
                    root_0 = this.adaptor.nil();

                    INT171=this.match(this.input,INT,SimpleCv4Parser.FOLLOW_INT_in_primaryExpr2785); if (this.state.failed) return retval;
                    if ( this.state.backtracking===0 ) {
                    ...
                    break;
                case 3 :
                    // SimpleCv4.g:343:9: STRING
                    root_0 = this.adaptor.nil();

                    STRING172=this.match(this.input,STRING,SimpleCv4Parser.FOLLOW_STRING_in_primaryExpr2795); if (this.state.failed) return retval;
                    if ( this.state.backtracking===0 ) {
                    ...
                    break;
                case 4 :
                    // SimpleCv4.g:344:9: '(' expression ')'
                    root_0 = this.adaptor.nil();

                    char_literal173=this.match(this.input,122,SimpleCv4Parser.FOLLOW_122_in_primaryExpr2805); if (this.state.failed) return retval;
                    if ( this.state.backtracking===0 ) {
                    char_literal173_tree = this.adaptor.create(char_literal173);
                    this.adaptor.addChild(root_0, char_literal173_tree);
                    }
                    this.pushFollow(SimpleCv4Parser.FOLLOW_expression_in_primaryExpr2807);
                    expression174=this.expression();

                    this.state._fsp--;
                    if (this.state.failed) return retval;
                    if ( this.state.backtracking===0 ) this.adaptor.addChild(root_0, expression174.getTree());
                    char_literal175=this.match(this.input,123,SimpleCv4Parser.FOLLOW_123_in_primaryExpr2809); if (this.state.failed) return retval;
                    if ( this.state.backtracking===0 ) {
    ...
    // SimpleCv4.g:347:1: conditionalExpr : logicalOrExpr -> ^( CONDITION logicalOrExpr ) ;
    ...
    conditionalExpr: function() {
        ...
        try {
            // SimpleCv4.g:348:5: ( logicalOrExpr -> ^( CONDITION logicalOrExpr ) )
            // SimpleCv4.g:348:9: logicalOrExpr
            this.pushFollow(SimpleCv4Parser.FOLLOW_logicalOrExpr_in_conditionalExpr2828);
            ...
            root_0 = this.adaptor.nil();
            // 349:5: -> ^( CONDITION logicalOrExpr )
            {
                // SimpleCv4.g:349:8: ^( CONDITION logicalOrExpr )
                {
                var root_1 = this.adaptor.nil();
    ...
    // SimpleCv4.g:352:1: logicalOrExpr : logicalAndExpr ( '||' logicalAndExpr )* -> ^( OR_EXPR ( ^( OR_BRANCH logicalAndExpr ) )+ ) ;
    ...
    logicalOrExpr: function() {
        ...
        try {
            // SimpleCv4.g:353:5: ( logicalAndExpr ( '||' logicalAndExpr )* -> ^( OR_EXPR ( ^( OR_BRANCH logicalAndExpr ) )+ ) )
            // SimpleCv4.g:353:7: logicalAndExpr ( '||' logicalAndExpr )*
            this.pushFollow(SimpleCv4Parser.FOLLOW_logicalAndExpr_in_logicalOrExpr2858);
            logicalAndExpr177=this.logicalAndExpr();

            this.state._fsp--;
            if (this.state.failed) return retval;
            if ( this.state.backtracking===0 ) stream_logicalAndExpr.add(logicalAndExpr177.getTree());
            // SimpleCv4.g:353:22: ( '||' logicalAndExpr )*
            loop36:
            do {
                var alt36=2;
                ...
                switch (alt36) {
                case 1 :
                    // SimpleCv4.g:353:23: '||' logicalAndExpr
                    string_literal178=this.match(this.input,150,SimpleCv4Parser.FOLLOW_150_in_logicalOrExpr2861); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_150.add(string_literal178);

                    this.pushFollow(SimpleCv4Parser.FOLLOW_logicalAndExpr_in_logicalOrExpr2863);
            ...
            root_0 = this.adaptor.nil();
            // 354:5: -> ^( OR_EXPR ( ^( OR_BRANCH logicalAndExpr ) )+ )
            {
                // SimpleCv4.g:354:8: ^( OR_EXPR ( ^( OR_BRANCH logicalAndExpr ) )+ )
                {
                var root_1 = this.adaptor.nil();
                ...
                while ( stream_logicalAndExpr.hasNext() ) {
                    // SimpleCv4.g:354:18: ^( OR_BRANCH logicalAndExpr )
                    {
                    var root_2 = this.adaptor.nil();
    ...
    // SimpleCv4.g:357:1: logicalAndExpr : relationExpr ( '&&' relationExpr )* -> ^( AND_EXPR ( ^( AND_BRANCH relationExpr ) )+ ) ;
    ...
    logicalAndExpr: function() {
        ...
        try {
            // SimpleCv4.g:358:5: ( relationExpr ( '&&' relationExpr )* -> ^( AND_EXPR ( ^( AND_BRANCH relationExpr ) )+ ) )
            // SimpleCv4.g:358:7: relationExpr ( '&&' relationExpr )*
            this.pushFollow(SimpleCv4Parser.FOLLOW_relationExpr_in_logicalAndExpr2899);
            relationExpr180=this.relationExpr();

            this.state._fsp--;
            if (this.state.failed) return retval;
            if ( this.state.backtracking===0 ) stream_relationExpr.add(relationExpr180.getTree());
            // SimpleCv4.g:358:20: ( '&&' relationExpr )*
            loop37:
            do {
                var alt37=2;
                ...
                switch (alt37) {
                case 1 :
                    // SimpleCv4.g:358:21: '&&' relationExpr
                    string_literal181=this.match(this.input,151,SimpleCv4Parser.FOLLOW_151_in_logicalAndExpr2902); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_151.add(string_literal181);

                    this.pushFollow(SimpleCv4Parser.FOLLOW_relationExpr_in_logicalAndExpr2904);
            ...
            root_0 = this.adaptor.nil();
            // 359:5: -> ^( AND_EXPR ( ^( AND_BRANCH relationExpr ) )+ )
            {
                // SimpleCv4.g:359:8: ^( AND_EXPR ( ^( AND_BRANCH relationExpr ) )+ )
                {
                var root_1 = this.adaptor.nil();
                ...
                while ( stream_relationExpr.hasNext() ) {
                    // SimpleCv4.g:359:19: ^( AND_BRANCH relationExpr )
                    {
                    var root_2 = this.adaptor.nil();
    ...
    // SimpleCv4.g:362:1: relationExpr : shiftExpr ( relationOp shiftExpr )* -> ^( RELATION_EXPR shiftExpr ( relationOp shiftExpr )* ) ;
    ...
    relationExpr: function() {
        ...
        var stream_shiftExpr=new org.antlr.runtime.tree.RewriteRuleSubtreeStream(this.adaptor,"rule shiftExpr");
        try {
            // SimpleCv4.g:363:5: ( shiftExpr ( relationOp shiftExpr )* -> ^( RELATION_EXPR shiftExpr ( relationOp shiftExpr )* ) )
            // SimpleCv4.g:363:7: shiftExpr ( relationOp shiftExpr )*
            this.pushFollow(SimpleCv4Parser.FOLLOW_shiftExpr_in_relationExpr2940);
            shiftExpr183=this.shiftExpr();

            this.state._fsp--;
            if (this.state.failed) return retval;
            if ( this.state.backtracking===0 ) stream_shiftExpr.add(shiftExpr183.getTree());
            // SimpleCv4.g:363:17: ( relationOp shiftExpr )*
            loop38:
            do {
                var alt38=2;
                var LA38_0 = this.input.LA(1);

                if ( ((LA38_0>=104 && LA38_0<=105)||(LA38_0>=152 && LA38_0<=155)) ) {
                    alt38=1;
                }
                ...
                switch (alt38) {
                case 1 :
                    // SimpleCv4.g:363:18: relationOp shiftExpr
                    this.pushFollow(SimpleCv4Parser.FOLLOW_relationOp_in_relationExpr2943);
                    relationOp184=this.relationOp();

                    this.state._fsp--;
                    if (this.state.failed) return retval;
                    if ( this.state.backtracking===0 ) stream_relationOp.add(relationOp184.getTree());
                    this.pushFollow(SimpleCv4Parser.FOLLOW_shiftExpr_in_relationExpr2945);
            ...
            root_0 = this.adaptor.nil();
            // 364:5: -> ^( RELATION_EXPR shiftExpr ( relationOp shiftExpr )* )
            {
                // SimpleCv4.g:364:8: ^( RELATION_EXPR shiftExpr ( relationOp shiftExpr )* )
                {
                var root_1 = this.adaptor.nil();
                root_1 = this.adaptor.becomeRoot(this.adaptor.create(RELATION_EXPR, "RELATION_EXPR"), root_1);

                this.adaptor.addChild(root_1, stream_shiftExpr.nextTree());
                // SimpleCv4.g:364:34: ( relationOp shiftExpr )*
    ...
    // SimpleCv4.g:367:1: relationOp : ( '==' -> EQUAL_RE | '!=' -> NOTEQUAL_RE | '<' -> LESS_RE | '>' -> GREATER_RE | '<=' -> LESSEQUAL_RE | '>=' -> GREATEREQUAL_RE );
    ...
    relationOp: function() {
        ...
        try {
            // SimpleCv4.g:368:5: ( '==' -> EQUAL_RE | '!=' -> NOTEQUAL_RE | '<' -> LESS_RE | '>' -> GREATER_RE | '<=' -> LESSEQUAL_RE | '>=' -> GREATEREQUAL_RE )
            var alt39=6;
            switch ( this.input.LA(1) ) {
            case 152:
                alt39=1;
            ...
            switch (alt39) {
                case 1 :
                    // SimpleCv4.g:368:7: '=='
                    string_literal186=this.match(this.input,152,SimpleCv4Parser.FOLLOW_152_in_relationOp2987); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_152.add(string_literal186);
                ...
                case 2 :
                    // SimpleCv4.g:370:7: '!='
                    string_literal187=this.match(this.input,153,SimpleCv4Parser.FOLLOW_153_in_relationOp3004); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_153.add(string_literal187);
                ...
                case 3 :
                    // SimpleCv4.g:372:7: '<'
                    char_literal188=this.match(this.input,104,SimpleCv4Parser.FOLLOW_104_in_relationOp3021); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_104.add(char_literal188);
                ...
                case 4 :
                    // SimpleCv4.g:374:7: '>'
                    char_literal189=this.match(this.input,105,SimpleCv4Parser.FOLLOW_105_in_relationOp3038); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_105.add(char_literal189);
                ...
                case 5 :
                    // SimpleCv4.g:376:7: '<='
                    string_literal190=this.match(this.input,154,SimpleCv4Parser.FOLLOW_154_in_relationOp3055); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_154.add(string_literal190);
                ...
                case 6 :
                    // SimpleCv4.g:378:7: '>='
                    string_literal191=this.match(this.input,155,SimpleCv4Parser.FOLLOW_155_in_relationOp3072); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_155.add(string_literal191);
    ...
    // SimpleCv4.g:382:1: shiftExpr : addSubExpr ( shiftOp addSubExpr )* -> ^( SHIFT_EXPR addSubExpr ( ^( shiftOp addSubExpr ) )* ) ;
    ...
    shiftExpr: function() {
        ...
        try {
            // SimpleCv4.g:383:5: ( addSubExpr ( shiftOp addSubExpr )* -> ^( SHIFT_EXPR addSubExpr ( ^( shiftOp addSubExpr ) )* ) )
            // SimpleCv4.g:383:9: addSubExpr ( shiftOp addSubExpr )*
            this.pushFollow(SimpleCv4Parser.FOLLOW_addSubExpr_in_shiftExpr3101);
            addSubExpr192=this.addSubExpr();

            this.state._fsp--;
            if (this.state.failed) return retval;
            if ( this.state.backtracking===0 ) stream_addSubExpr.add(addSubExpr192.getTree());
            // SimpleCv4.g:383:20: ( shiftOp addSubExpr )*
            loop40:
            do {
                var alt40=2;
                var LA40_0 = this.input.LA(1);

                if ( ((LA40_0>=156 && LA40_0<=157)) ) {
                    alt40=1;
                }
                ...
                switch (alt40) {
                case 1 :
                    // SimpleCv4.g:383:21: shiftOp addSubExpr
                    this.pushFollow(SimpleCv4Parser.FOLLOW_shiftOp_in_shiftExpr3104);
            ...
            root_0 = this.adaptor.nil();
            // 384:5: -> ^( SHIFT_EXPR addSubExpr ( ^( shiftOp addSubExpr ) )* )
            {
                // SimpleCv4.g:384:8: ^( SHIFT_EXPR addSubExpr ( ^( shiftOp addSubExpr ) )* )
                {
                var root_1 = this.adaptor.nil();
                ...
                // SimpleCv4.g:384:32: ( ^( shiftOp addSubExpr ) )*
    ...
    // SimpleCv4.g:386:1: shiftOp : ( '<<' -> SHL_OP | '>>' -> SHR_OP );
    // $ANTLR start "shiftOp"
    shiftOp: function() {
        ...
        try {
            // SimpleCv4.g:387:5: ( '<<' -> SHL_OP | '>>' -> SHR_OP )
            var alt41=2;
            ...
            switch (alt41) {
                case 1 :
                    // SimpleCv4.g:387:7: '<<'
                    string_literal195=this.match(this.input,156,SimpleCv4Parser.FOLLOW_156_in_shiftOp3143); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_156.add(string_literal195);
                ...
                case 2 :
                    // SimpleCv4.g:389:7: '>>'
                    string_literal196=this.match(this.input,157,SimpleCv4Parser.FOLLOW_157_in_shiftOp3159); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_157.add(string_literal196);
    ...
    // SimpleCv4.g:393:1: addSubExpr : multDivExpr ( addSubOp multDivExpr )* -> ^( ADDSUB_EXPR multDivExpr ( ^( addSubOp multDivExpr ) )* ) ;
    ...
    addSubExpr: function() {
        ...
        try {
            // SimpleCv4.g:394:5: ( multDivExpr ( addSubOp multDivExpr )* -> ^( ADDSUB_EXPR multDivExpr ( ^( addSubOp multDivExpr ) )* ) )
            // SimpleCv4.g:394:9: multDivExpr ( addSubOp multDivExpr )*
            this.pushFollow(SimpleCv4Parser.FOLLOW_multDivExpr_in_addSubExpr3186);
            multDivExpr197=this.multDivExpr();

            this.state._fsp--;
            if (this.state.failed) return retval;
            if ( this.state.backtracking===0 ) stream_multDivExpr.add(multDivExpr197.getTree());
            // SimpleCv4.g:394:21: ( addSubOp multDivExpr )*
            loop42:
            do {
                var alt42=2;
                var LA42_0 = this.input.LA(1);

                if ( ((LA42_0>=158 && LA42_0<=159)) ) {
                    alt42=1;
                }
                ...
                switch (alt42) {
                case 1 :
                    // SimpleCv4.g:394:22: addSubOp multDivExpr
                    this.pushFollow(SimpleCv4Parser.FOLLOW_addSubOp_in_addSubExpr3189);
                    addSubOp198=this.addSubOp();

                    this.state._fsp--;
                    if (this.state.failed) return retval;
                    if ( this.state.backtracking===0 ) stream_addSubOp.add(addSubOp198.getTree());
                    this.pushFollow(SimpleCv4Parser.FOLLOW_multDivExpr_in_addSubExpr3191);
            ...
            root_0 = this.adaptor.nil();
            // 395:5: -> ^( ADDSUB_EXPR multDivExpr ( ^( addSubOp multDivExpr ) )* )
            {
                // SimpleCv4.g:395:8: ^( ADDSUB_EXPR multDivExpr ( ^( addSubOp multDivExpr ) )* )
                {
                var root_1 = this.adaptor.nil();
                ...
                // SimpleCv4.g:395:34: ( ^( addSubOp multDivExpr ) )*
    ...
    // SimpleCv4.g:397:1: addSubOp : ( '+' -> ADD_OP | '-' -> SUB_OP );
    ...
    addSubOp: function() {
        ...
        try {
            // SimpleCv4.g:398:5: ( '+' -> ADD_OP | '-' -> SUB_OP )
            var alt43=2;
            ...
            switch (alt43) {
                case 1 :
                    // SimpleCv4.g:398:7: '+'
                    char_literal200=this.match(this.input,158,SimpleCv4Parser.FOLLOW_158_in_addSubOp3228); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_158.add(char_literal200);
                ...
                case 2 :
                    // SimpleCv4.g:400:7: '-'
                    char_literal201=this.match(this.input,159,SimpleCv4Parser.FOLLOW_159_in_addSubOp3244); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_159.add(char_literal201);
    ...
    // SimpleCv4.g:404:1: multDivExpr : castExpr ( multDivOp castExpr )* -> ^( MULTDIV_EXPR castExpr ( ^( multDivOp castExpr ) )* ) ;
    ...
    multDivExpr: function() {
        ...
        try {
            // SimpleCv4.g:405:5: ( castExpr ( multDivOp castExpr )* -> ^( MULTDIV_EXPR castExpr ( ^( multDivOp castExpr ) )* ) )
            // SimpleCv4.g:405:9: castExpr ( multDivOp castExpr )*
            this.pushFollow(SimpleCv4Parser.FOLLOW_castExpr_in_multDivExpr3272);
            castExpr202=this.castExpr();

            this.state._fsp--;
            if (this.state.failed) return retval;
            if ( this.state.backtracking===0 ) stream_castExpr.add(castExpr202.getTree());
            // SimpleCv4.g:405:18: ( multDivOp castExpr )*
            loop44:
            do {
                var alt44=2;
                var LA44_0 = this.input.LA(1);

                if ( (LA44_0==108||(LA44_0>=160 && LA44_0<=161)) ) {
                    alt44=1;
                }
                ...
                switch (alt44) {
                case 1 :
                    // SimpleCv4.g:405:19: multDivOp castExpr
                    this.pushFollow(SimpleCv4Parser.FOLLOW_multDivOp_in_multDivExpr3275);
                    multDivOp203=this.multDivOp();

                    this.state._fsp--;
                    if (this.state.failed) return retval;
                    if ( this.state.backtracking===0 ) stream_multDivOp.add(multDivOp203.getTree());
                    this.pushFollow(SimpleCv4Parser.FOLLOW_castExpr_in_multDivExpr3277);
            ...
            root_0 = this.adaptor.nil();
            // 406:5: -> ^( MULTDIV_EXPR castExpr ( ^( multDivOp castExpr ) )* )
            {
                // SimpleCv4.g:406:8: ^( MULTDIV_EXPR castExpr ( ^( multDivOp castExpr ) )* )
                {
                var root_1 = this.adaptor.nil();
                ...
                // SimpleCv4.g:406:32: ( ^( multDivOp castExpr ) )*
    ...
    multDivOp: function() {
        ...
        try {
            ...
            switch (alt45) {
                case 1 :
                    // SimpleCv4.g:410:7: '*'
                    char_literal205=this.match(this.input,108,SimpleCv4Parser.FOLLOW_108_in_multDivOp3315); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_108.add(char_literal205);
                ...
                case 2 :
                    // SimpleCv4.g:412:7: '/'
                    char_literal206=this.match(this.input,160,SimpleCv4Parser.FOLLOW_160_in_multDivOp3331); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_160.add(char_literal206);
                ...
                case 3 :
                    // SimpleCv4.g:414:7: '%'
                    char_literal207=this.match(this.input,161,SimpleCv4Parser.FOLLOW_161_in_multDivOp3347); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_161.add(char_literal207);
        ...
        try {
            ...
            switch (alt46) {
                case 1 :
                    ...
                    char_literal208=this.match(this.input,122,SimpleCv4Parser.FOLLOW_122_in_castExpr3374); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_122.add(char_literal208);

                    this.pushFollow(SimpleCv4Parser.FOLLOW_type_in_castExpr3376);
                    type209=this.type();

                    this.state._fsp--;
                    if (this.state.failed) return retval;
                    if ( this.state.backtracking===0 ) stream_type.add(type209.getTree());
                    char_literal210=this.match(this.input,123,SimpleCv4Parser.FOLLOW_123_in_castExpr3378); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_123.add(char_literal210);

                    this.pushFollow(SimpleCv4Parser.FOLLOW_castExpr_in_castExpr3380);
                ...
                case 2 :
                    ...
                    char_literal212=this.match(this.input,122,SimpleCv4Parser.FOLLOW_122_in_castExpr3402); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_122.add(char_literal212);

                    this.pushFollow(SimpleCv4Parser.FOLLOW_conditionalExpr_in_castExpr3404);
                    ...
                    char_literal214=this.match(this.input,123,SimpleCv4Parser.FOLLOW_123_in_castExpr3406); if (this.state.failed) return retval; 
                    if ( this.state.backtracking===0 ) stream_123.add(char_literal214);
                ...
                case 3 :
                    ...
                    this.pushFollow(SimpleCv4Parser.FOLLOW_unaryExpr_in_castExpr3428);
    ...
    synpred6_SimpleCv4_fragment: function() {
        // SimpleCv4.g:122:9: ( functionHeader ';' )
        // SimpleCv4.g:122:9: functionHeader ';'
        this.pushFollow(SimpleCv4Parser.FOLLOW_functionHeader_in_synpred6_SimpleCv4809);
        this.functionHeader();

        this.state._fsp--;
        if (this.state.failed) return ;
        this.match(this.input,101,SimpleCv4Parser.FOLLOW_101_in_synpred6_SimpleCv4811); if (this.state.failed) return ;
    ...
    synpred28_SimpleCv4_fragment: function() {
        // SimpleCv4.g:220:13: ( variable )
        // SimpleCv4.g:220:13: variable
        this.pushFollow(SimpleCv4Parser.FOLLOW_variable_in_synpred28_SimpleCv41591);
        this.variable();
    ...
    synpred37_SimpleCv4_fragment: function() {
        // SimpleCv4.g:252:46: ( 'else' 'if' '(' conditionalExpr ')' block )
        // SimpleCv4.g:252:46: 'else' 'if' '(' conditionalExpr ')' block
        this.match(this.input,128,SimpleCv4Parser.FOLLOW_128_in_synpred37_SimpleCv41934); if (this.state.failed) return ;
        this.match(this.input,127,SimpleCv4Parser.FOLLOW_127_in_synpred37_SimpleCv41936); if (this.state.failed) return ;
        this.match(this.input,122,SimpleCv4Parser.FOLLOW_122_in_synpred37_SimpleCv41938); if (this.state.failed) return ;
        this.pushFollow(SimpleCv4Parser.FOLLOW_conditionalExpr_in_synpred37_SimpleCv41940);
        this.conditionalExpr();

        this.state._fsp--;
        if (this.state.failed) return ;
        this.match(this.input,123,SimpleCv4Parser.FOLLOW_123_in_synpred37_SimpleCv41942); if (this.state.failed) return ;
        this.pushFollow(SimpleCv4Parser.FOLLOW_block_in_synpred37_SimpleCv41944);
        this.block();
    ...
    synpred38_SimpleCv4_fragment: function() {
        // SimpleCv4.g:252:93: ( 'else' block )
        // SimpleCv4.g:252:93: 'else' block
        this.match(this.input,128,SimpleCv4Parser.FOLLOW_128_in_synpred38_SimpleCv41951); if (this.state.failed) return ;
        this.pushFollow(SimpleCv4Parser.FOLLOW_block_in_synpred38_SimpleCv41953);
        this.block();
    ...
    synpred44_SimpleCv4_fragment: function() {
        // SimpleCv4.g:271:9: ( assignmentExpr )
        // SimpleCv4.g:271:9: assignmentExpr
        this.pushFollow(SimpleCv4Parser.FOLLOW_assignmentExpr_in_synpred44_SimpleCv42160);
        this.assignmentExpr();
    ...
    synpred63_SimpleCv4_fragment: function() {
        // SimpleCv4.g:330:16: ( '[' shiftExpr ']' )
        // SimpleCv4.g:330:16: '[' shiftExpr ']'
        this.match(this.input,148,SimpleCv4Parser.FOLLOW_148_in_synpred63_SimpleCv42667); if (this.state.failed) return ;
        this.pushFollow(SimpleCv4Parser.FOLLOW_shiftExpr_in_synpred63_SimpleCv42669);
        this.shiftExpr();

        this.state._fsp--;
        if (this.state.failed) return ;
        this.match(this.input,149,SimpleCv4Parser.FOLLOW_149_in_synpred63_SimpleCv42671); if (this.state.failed) return ;
    ...
    synpred85_SimpleCv4_fragment: function() {
        // SimpleCv4.g:419:9: ( '(' type ')' castExpr )
        // SimpleCv4.g:419:9: '(' type ')' castExpr
        this.match(this.input,122,SimpleCv4Parser.FOLLOW_122_in_synpred85_SimpleCv43374); if (this.state.failed) return ;
        this.pushFollow(SimpleCv4Parser.FOLLOW_type_in_synpred85_SimpleCv43376);
        this.type();

        this.state._fsp--;
        if (this.state.failed) return ;
        this.match(this.input,123,SimpleCv4Parser.FOLLOW_123_in_synpred85_SimpleCv43378); if (this.state.failed) return ;
        this.pushFollow(SimpleCv4Parser.FOLLOW_castExpr_in_synpred85_SimpleCv43380);
        this.castExpr();
    ...
    synpred86_SimpleCv4_fragment: function() {
        // SimpleCv4.g:421:7: ( '(' conditionalExpr ')' )
        // SimpleCv4.g:421:7: '(' conditionalExpr ')'
        this.match(this.input,122,SimpleCv4Parser.FOLLOW_122_in_synpred86_SimpleCv43402); if (this.state.failed) return ;
        this.pushFollow(SimpleCv4Parser.FOLLOW_conditionalExpr_in_synpred86_SimpleCv43404);
        this.conditionalExpr();

        this.state._fsp--;
        if (this.state.failed) return ;
        this.match(this.input,123,SimpleCv4Parser.FOLLOW_123_in_synpred86_SimpleCv43406); if (this.state.failed) return ;
...
// public class variables
org.antlr.lang.augmentObject(SimpleCv4Parser, {
    tokenNames: ["<invalid>", "<EOR>", "<DOWN>", "<UP>", "PROG", "INCLUDE_SYSTEM", "TYPE_DEF", "TYPE_OLD", "TYPE_NEW", "STRUCT_DEF", "STRUCT_CNAME", "VAR_DEF", "VAR_NAME", "C_TYPE", "C_ID", "DEFAULT_VALUE", "TYPE_VOID", "TYPE_I8", "TYPE_I16", "TYPE_I32", "TYPE_UNSIGNED", "TYPE_F32", "TYPE_F64", "TYPE_CUSTOM", "FUNC_DEF", "FUNC_STAT", "FUNC_NAME", "FUNC_HEADER", "FUNC_PARAM", "FUNC_INVOKE", "FOR_STAT", "WHILE_STAT", "DOWHILE_STAT", "IF_STAT", "IF_BRANCH", "ELSEIF_BRANCH", "ELSE_BRANCH", "JUMP_STAT", "JUMP_RETURN", "JUMP_BREAK", "JUMP_CONTINUE", "BLOCK", "EMPTY_BLOCK", "ASSIGNMENT", "ASSIGN", "PLUS_ASSIGN", "MINUS_ASSIGN", "MULTI_ASSIGN", "DIVIDE_ASSIGN", "SHL_ASSIGN", "SHR_ASSIGN", "AND_ASSIGN", "OR_ASSIGN", "NOT_ASSIGN", "CONDITION", "SUB_CONDITION", "OR_EXPR", "OR_BRANCH", "AND_EXPR", "AND_BRANCH", "SHIFT_EXPR", "ADDSUB_EXPR", "MULTDIV_EXPR", "CASTTYPE", "SHL_OP", "SHR_OP", "ADD_OP", "SUB_OP", "MULTI_OP", "DIV_OP", "MOD_OP", "RELATION_EXPR", "EQUAL_RE", "NOTEQUAL_RE", "LESS_RE", "GREATER_RE", "GREATEREQUAL_RE", "LESSEQUAL_RE", "PREFIX_PLUS", "PREFIX_MINUS", "PREFIX_NOT", "PREFIX_AND", "PREFIX_STAR", "SIZEOF", "POSTFIX_EXPR", "POSTFIX", "POSTFIX_PLUS", "POSTFIX_MINUS", "MEMBERVAR", "ARRAYINDEX", "ID", "INT", "STRING", "EXPONENT", "FLOAT", "WS", "CHINESECHAR", "MULTILINE_COMMENT", "SINGLELINE_COMMENT", "EscapeSequence", "OctalEscape", "';'", "'#'", "'include'", "'<'", "'>'", "'.'", "','", "'*'", "'void'", "'char'", "'short'", "'int'", "'long'", "'float'", "'double'", "'signed'", "'unsigned'", "'typedef'", "'struct'", "'{'", "'}'", "'('", "')'", "'for'", "'while'", "'do'", "'if'", "'else'", "'continue'", "'break'", "'return'", "'='", "'+='", "'-='", "'*='", "'/='", "'<<='", "'>>='", "'&='", "'|='", "'^='", "'++'", "'--'", "'sizeof'", "'!'", "'&'", "'->'", "'['", "']'", "'||'", "'&&'", "'=='", "'!='", "'<='", "'>='", "'<<'", "'>>'", "'+'", "'-'", "'/'", "'%'"],
    FOLLOW_statement_in_program735: new org.antlr.runtime.BitSet([0x00000002, 0x00000000,0x04000000, 0x00FFE040]),
    FOLLOW_declaration_in_statement769: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_variable_in_statement779: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_structDefinition_in_statement789: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_typeDefinition_in_statement799: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_functionHeader_in_statement809: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x00000020]),
    FOLLOW_101_in_statement811: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_functionHeader_in_statement834: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0xF5001020,0x0007C00E, 0x00000000]),
    FOLLOW_block_in_statement836: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_102_in_declaration870: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x00000080]),
    FOLLOW_103_in_declaration872: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x00000100]),
    FOLLOW_104_in_declaration874: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x04000000, 0x00000000]),
    FOLLOW_libname_in_declaration876: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x00000200]),
    FOLLOW_105_in_declaration878: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_ID_in_libname911: new org.antlr.runtime.BitSet([0x00000002, 0x00000000,0x00000000, 0x00000400]),
    FOLLOW_106_in_libname914: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x04000000, 0x00000000]),
    FOLLOW_ID_in_libname916: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_type_in_variable938: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x04000000, 0x00000000]),
    FOLLOW_declarator_in_variable940: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x00000820,0x00003FF0, 0x00000000]),
    FOLLOW_assignmentOp_in_variable943: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0x04001000,0x0007C000, 0x00000000]),
    FOLLOW_conditionalExpr_in_variable945: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x00000820]),
    FOLLOW_107_in_variable950: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x04000000, 0x00001000]),
    FOLLOW_108_in_variable952: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x04000000, 0x00000000]),
    FOLLOW_declarator_in_variable955: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x00000820,0x00003FF0, 0x00000000]),
    FOLLOW_assignmentOp_in_variable958: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0x04001000,0x0007C000, 0x00000000]),
    FOLLOW_shiftExpr_in_variable960: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x00000820]),
    FOLLOW_101_in_variable966: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_typeSpecifier_in_type1014: new org.antlr.runtime.BitSet([0x00000002, 0x00000000,0x00000000, 0x00001000]),
    FOLLOW_108_in_type1016: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_109_in_typeSpecifier1051: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_110_in_typeSpecifier1062: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_111_in_typeSpecifier1073: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_112_in_typeSpecifier1084: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_113_in_typeSpecifier1095: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_114_in_typeSpecifier1106: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_115_in_typeSpecifier1117: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_116_in_typeSpecifier1128: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_117_in_typeSpecifier1139: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_ID_in_typeSpecifier1154: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_ID_in_declarator1182: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_118_in_typeDefinition1203: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x04000000, 0x003FE000]),
    FOLLOW_oldTypeName_in_typeDefinition1205: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x04000000, 0x00000000]),
    FOLLOW_newTypeName_in_typeDefinition1207: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x00000020]),
    FOLLOW_101_in_typeDefinition1209: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_typeSpecifier_in_oldTypeName1250: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_ID_in_newTypeName1270: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_118_in_structDefinition1297: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x00800000]),
    FOLLOW_119_in_structDefinition1302: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x04000000, 0x00000000]),
    FOLLOW_structName_in_structDefinition1304: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x01000000]),
    FOLLOW_structBlock_in_structDefinition1306: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x04000000, 0x00000020]),
    FOLLOW_structVar_in_structDefinition1310: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x00000820]),
    FOLLOW_107_in_structDefinition1314: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x04000000, 0x00000000]),
    FOLLOW_structVar_in_structDefinition1316: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x00000820]),
    FOLLOW_101_in_structDefinition1324: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_ID_in_structName1365: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_declarator_in_structVar1384: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_120_in_structBlock1416: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x04000000, 0x023FE000]),
    FOLLOW_variable_in_structBlock1430: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x04000000, 0x023FE000]),
    FOLLOW_121_in_structBlock1441: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_type_in_functionHeader1470: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x04000000, 0x00000000]),
    FOLLOW_ID_in_functionHeader1472: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x04000000]),
    FOLLOW_122_in_functionHeader1474: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x04000000, 0x083FE000]),
    FOLLOW_formalParameter_in_functionHeader1478: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x08000800]),
    FOLLOW_107_in_functionHeader1482: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x04000000, 0x003FE000]),
    FOLLOW_formalParameter_in_functionHeader1484: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x08000800]),
    FOLLOW_123_in_functionHeader1492: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_type_in_formalParameter1533: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x04000000, 0x00000000]),
    FOLLOW_declarator_in_formalParameter1535: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_120_in_block1577: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0xF63FF000,0x0007C00E, 0x00000000]),
    FOLLOW_variable_in_block1591: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0xF63FF000,0x0007C00E, 0x00000000]),
    FOLLOW_stat_in_block1606: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0xF6001000,0x0007C00E, 0x00000000]),
    FOLLOW_121_in_block1617: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_stat_in_block1647: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_101_in_block1670: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_forStat_in_stat1698: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_whileStat_in_stat1708: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_ifStat_in_stat1718: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_expression_in_stat1728: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x00000020]),
    FOLLOW_101_in_stat1730: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_jumpStat_in_stat1760: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_124_in_forStat1780: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x04000000]),
    FOLLOW_122_in_forStat1782: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0x04001000,0x0007C000, 0x00000000]),
    FOLLOW_assignmentExpr_in_forStat1784: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x00000020]),
    FOLLOW_101_in_forStat1786: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0x04001000,0x0007C000, 0x00000000]),
    FOLLOW_conditionalExpr_in_forStat1788: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x00000020]),
    FOLLOW_101_in_forStat1790: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0x04001000,0x0007C000, 0x00000000]),
    FOLLOW_expression_in_forStat1792: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x08000000]),
    FOLLOW_123_in_forStat1794: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0xF5001020,0x0007C00E, 0x00000000]),
    FOLLOW_block_in_forStat1796: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_125_in_whileStat1845: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x04000000]),
    FOLLOW_122_in_whileStat1847: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0x04001000,0x0007C000, 0x00000000]),
    FOLLOW_conditionalExpr_in_whileStat1849: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x08000000]),
    FOLLOW_123_in_whileStat1851: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0xF5001020,0x0007C00E, 0x00000000]),
    FOLLOW_block_in_whileStat1853: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_126_in_whileStat1877: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0xF5001020,0x0007C00E, 0x00000000]),
    FOLLOW_block_in_whileStat1879: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x20000000]),
    FOLLOW_125_in_whileStat1881: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x04000000]),
    FOLLOW_122_in_whileStat1883: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0x04001000,0x0007C000, 0x00000000]),
    FOLLOW_conditionalExpr_in_whileStat1885: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x08000000]),
    FOLLOW_123_in_whileStat1887: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x00000020]),
    FOLLOW_101_in_whileStat1889: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_127_in_ifStat1922: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x04000000]),
    FOLLOW_122_in_ifStat1924: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0x04001000,0x0007C000, 0x00000000]),
    FOLLOW_conditionalExpr_in_ifStat1926: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x08000000]),
    FOLLOW_123_in_ifStat1928: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0xF5001020,0x0007C00E, 0x00000000]),
    FOLLOW_block_in_ifStat1930: new org.antlr.runtime.BitSet([0x00000002, 0x00000000,0x00000000, 0x00000000,0x00000001, 0x00000000]),
    FOLLOW_128_in_ifStat1934: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x80000000]),
    FOLLOW_127_in_ifStat1936: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x04000000]),
    FOLLOW_122_in_ifStat1938: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0x04001000,0x0007C000, 0x00000000]),
    FOLLOW_conditionalExpr_in_ifStat1940: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x08000000]),
    FOLLOW_123_in_ifStat1942: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0xF5001020,0x0007C00E, 0x00000000]),
    FOLLOW_block_in_ifStat1944: new org.antlr.runtime.BitSet([0x00000002, 0x00000000,0x00000000, 0x00000000,0x00000001, 0x00000000]),
    FOLLOW_128_in_ifStat1951: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0xF5001020,0x0007C00E, 0x00000000]),
    FOLLOW_block_in_ifStat1953: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_129_in_jumpStat2008: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x00000020]),
    FOLLOW_101_in_jumpStat2010: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_130_in_jumpStat2031: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x00000020]),
    FOLLOW_101_in_jumpStat2033: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_131_in_jumpStat2054: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0x04001020,0x0007C000, 0x00000000]),
    FOLLOW_expression_in_jumpStat2057: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x00000020]),
    FOLLOW_101_in_jumpStat2061: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_ID_in_funcInvoke2099: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x04000000]),
    FOLLOW_122_in_funcInvoke2101: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0x0C001000,0x0007C000, 0x00000000]),
    FOLLOW_shiftExpr_in_funcInvoke2105: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x08000800]),
    FOLLOW_107_in_funcInvoke2109: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0x04001000,0x0007C000, 0x00000000]),
    FOLLOW_shiftExpr_in_funcInvoke2111: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x08000800]),
    FOLLOW_123_in_funcInvoke2118: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_assignmentExpr_in_expression2160: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_conditionalExpr_in_expression2168: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_unaryExpr_in_assignmentExpr2187: new org.antlr.runtime.BitSet([0x00000002, 0x00000000,0x00000000, 0x00000000,0x00003FF0, 0x00000000]),
    FOLLOW_assignmentOp_in_assignmentExpr2190: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0x04001000,0x0007C000, 0x00000000]),
    FOLLOW_shiftExpr_in_assignmentExpr2192: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_132_in_assignmentOp2233: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_133_in_assignmentOp2252: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_134_in_assignmentOp2271: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_135_in_assignmentOp2290: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_136_in_assignmentOp2309: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_137_in_assignmentOp2328: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_138_in_assignmentOp2347: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_139_in_assignmentOp2366: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_140_in_assignmentOp2385: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_141_in_assignmentOp2404: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_postfixExpr_in_unaryExpr2435: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_142_in_unaryExpr2445: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0x04001000,0x0007C000, 0x00000000]),
    FOLLOW_unaryExpr_in_unaryExpr2447: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_143_in_unaryExpr2469: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0x04001000,0x0007C000, 0x00000000]),
    FOLLOW_unaryExpr_in_unaryExpr2471: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_144_in_unaryExpr2493: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x04000000]),
    FOLLOW_122_in_unaryExpr2495: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x04000000, 0x003FE000]),
    FOLLOW_type_in_unaryExpr2497: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x08000000]),
    FOLLOW_123_in_unaryExpr2499: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_unaryOp_in_unaryExpr2521: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0x04001000,0x0007C000, 0x00000000]),
    FOLLOW_castExpr_in_unaryExpr2523: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_funcInvoke_in_unaryExpr2531: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_145_in_unaryOp2554: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_146_in_unaryOp2572: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_108_in_unaryOp2590: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_primaryExpr_in_postfixExpr2617: new org.antlr.runtime.BitSet([0x00000002, 0x00000000,0x00000000, 0x00000000,0x0018C000, 0x00000000]),
    FOLLOW_postfix_in_postfixExpr2620: new org.antlr.runtime.BitSet([0x00000002, 0x00000000,0x00000000, 0x00000000,0x0018C000, 0x00000000]),
    FOLLOW_147_in_postfix2662: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x04000000, 0x00000000]),
    FOLLOW_ID_in_postfix2664: new org.antlr.runtime.BitSet([0x00000002, 0x00000000,0x00000000, 0x00000000,0x00100000, 0x00000000]),
    FOLLOW_148_in_postfix2667: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0x04001000,0x0007C000, 0x00000000]),
    FOLLOW_shiftExpr_in_postfix2669: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x00000000,0x00200000, 0x00000000]),
    FOLLOW_149_in_postfix2671: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_142_in_postfix2702: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_143_in_postfix2722: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_148_in_postfix2742: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0x04001000,0x0007C000, 0x00000000]),
    FOLLOW_expression_in_postfix2744: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x00000000,0x00200000, 0x00000000]),
    FOLLOW_149_in_postfix2746: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_declarator_in_primaryExpr2777: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_INT_in_primaryExpr2785: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_STRING_in_primaryExpr2795: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_122_in_primaryExpr2805: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0x04001000,0x0007C000, 0x00000000]),
    FOLLOW_expression_in_primaryExpr2807: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x08000000]),
    FOLLOW_123_in_primaryExpr2809: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_logicalOrExpr_in_conditionalExpr2828: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_logicalAndExpr_in_logicalOrExpr2858: new org.antlr.runtime.BitSet([0x00000002, 0x00000000,0x00000000, 0x00000000,0x00400000, 0x00000000]),
    FOLLOW_150_in_logicalOrExpr2861: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0x04001000,0x0007C000, 0x00000000]),
    FOLLOW_logicalAndExpr_in_logicalOrExpr2863: new org.antlr.runtime.BitSet([0x00000002, 0x00000000,0x00000000, 0x00000000,0x00400000, 0x00000000]),
    FOLLOW_relationExpr_in_logicalAndExpr2899: new org.antlr.runtime.BitSet([0x00000002, 0x00000000,0x00000000, 0x00000000,0x00800000, 0x00000000]),
    FOLLOW_151_in_logicalAndExpr2902: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0x04001000,0x0007C000, 0x00000000]),
    FOLLOW_relationExpr_in_logicalAndExpr2904: new org.antlr.runtime.BitSet([0x00000002, 0x00000000,0x00000000, 0x00000000,0x00800000, 0x00000000]),
    FOLLOW_shiftExpr_in_relationExpr2940: new org.antlr.runtime.BitSet([0x00000002, 0x00000000,0x00000000, 0x00000300,0x0F000000, 0x00000000]),
    FOLLOW_relationOp_in_relationExpr2943: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0x04001000,0x0007C000, 0x00000000]),
    FOLLOW_shiftExpr_in_relationExpr2945: new org.antlr.runtime.BitSet([0x00000002, 0x00000000,0x00000000, 0x00000300,0x0F000000, 0x00000000]),
    FOLLOW_152_in_relationOp2987: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_153_in_relationOp3004: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_104_in_relationOp3021: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_105_in_relationOp3038: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_154_in_relationOp3055: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_155_in_relationOp3072: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_addSubExpr_in_shiftExpr3101: new org.antlr.runtime.BitSet([0x00000002, 0x00000000,0x00000000, 0x00000000,0x30000000, 0x00000000]),
    FOLLOW_shiftOp_in_shiftExpr3104: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0x04001000,0x0007C000, 0x00000000]),
    FOLLOW_addSubExpr_in_shiftExpr3106: new org.antlr.runtime.BitSet([0x00000002, 0x00000000,0x00000000, 0x00000000,0x30000000, 0x00000000]),
    FOLLOW_156_in_shiftOp3143: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_157_in_shiftOp3159: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_multDivExpr_in_addSubExpr3186: new org.antlr.runtime.BitSet([0x00000002, 0x00000000,0x00000000, 0x00000000,0xC0000000, 0x00000000]),
    FOLLOW_addSubOp_in_addSubExpr3189: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0x04001000,0x0007C000, 0x00000000]),
    FOLLOW_multDivExpr_in_addSubExpr3191: new org.antlr.runtime.BitSet([0x00000002, 0x00000000,0x00000000, 0x00000000,0xC0000000, 0x00000000]),
    FOLLOW_158_in_addSubOp3228: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_159_in_addSubOp3244: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_castExpr_in_multDivExpr3272: new org.antlr.runtime.BitSet([0x00000002, 0x00000000,0x00000000, 0x00001000,0x00000000, 0x00000003]),
    FOLLOW_multDivOp_in_multDivExpr3275: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0x04001000,0x0007C000, 0x00000000]),
    FOLLOW_castExpr_in_multDivExpr3277: new org.antlr.runtime.BitSet([0x00000002, 0x00000000,0x00000000, 0x00001000,0x00000000, 0x00000003]),
    FOLLOW_108_in_multDivOp3315: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_160_in_multDivOp3331: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_161_in_multDivOp3347: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_122_in_castExpr3374: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x04000000, 0x003FE000]),
    FOLLOW_type_in_castExpr3376: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x08000000]),
    FOLLOW_123_in_castExpr3378: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0x04001000,0x0007C000, 0x00000000]),
    FOLLOW_castExpr_in_castExpr3380: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_122_in_castExpr3402: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0x04001000,0x0007C000, 0x00000000]),
    FOLLOW_conditionalExpr_in_castExpr3404: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x08000000]),
    FOLLOW_123_in_castExpr3406: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_unaryExpr_in_castExpr3428: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_functionHeader_in_synpred6_SimpleCv4809: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x00000020]),
    FOLLOW_101_in_synpred6_SimpleCv4811: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_variable_in_synpred28_SimpleCv41591: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_128_in_synpred37_SimpleCv41934: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x80000000]),
    FOLLOW_127_in_synpred37_SimpleCv41936: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x04000000]),
    FOLLOW_122_in_synpred37_SimpleCv41938: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0x04001000,0x0007C000, 0x00000000]),
    FOLLOW_conditionalExpr_in_synpred37_SimpleCv41940: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x08000000]),
    FOLLOW_123_in_synpred37_SimpleCv41942: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0xF5001020,0x0007C00E, 0x00000000]),
    FOLLOW_block_in_synpred37_SimpleCv41944: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_128_in_synpred38_SimpleCv41951: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0xF5001020,0x0007C00E, 0x00000000]),
    FOLLOW_block_in_synpred38_SimpleCv41953: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_assignmentExpr_in_synpred44_SimpleCv42160: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_148_in_synpred63_SimpleCv42667: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0x04001000,0x0007C000, 0x00000000]),
    FOLLOW_shiftExpr_in_synpred63_SimpleCv42669: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x00000000,0x00200000, 0x00000000]),
    FOLLOW_149_in_synpred63_SimpleCv42671: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_122_in_synpred85_SimpleCv43374: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x04000000, 0x003FE000]),
    FOLLOW_type_in_synpred85_SimpleCv43376: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x08000000]),
    FOLLOW_123_in_synpred85_SimpleCv43378: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0x04001000,0x0007C000, 0x00000000]),
    FOLLOW_castExpr_in_synpred85_SimpleCv43380: new org.antlr.runtime.BitSet([0x00000002, 0x00000000]),
    FOLLOW_122_in_synpred86_SimpleCv43402: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x1C000000, 0x04001000,0x0007C000, 0x00000000]),
    FOLLOW_conditionalExpr_in_synpred86_SimpleCv43404: new org.antlr.runtime.BitSet([0x00000000, 0x00000000,0x00000000, 0x08000000]),
    FOLLOW_123_in_synpred86_SimpleCv43406: new org.antlr.runtime.BitSet([0x00000002, 0x00000000])
});
